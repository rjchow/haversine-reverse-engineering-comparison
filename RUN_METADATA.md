...
All four agents received the same byte-identical brief, preserved in [`PROMPT.md`](PROMPT.md). Times below are UTC and cover only the original reverse-engineering effort begun from that brief; later related follow-ups are excluded.
